...
struct WalkthroughScreen: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            if currentPage == 4 {
                ScreenView(image: "img4", title: "Community Support", detail: "Your trusted partner for a safe and healthy pregnancy journey")
                    .transition(.scale)
            }
            
            if currentPage == 5 {
                ScreenView(image: "img5", title: "Appointment Scheduler", detail: "Your trusted partner for a safe and healthy pregnancy journey")
                    .transition(.scale)
            }
